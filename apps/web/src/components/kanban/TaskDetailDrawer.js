...
import { X, ExternalLink, CheckCircle2, AlertTriangle, Clock, GitPullRequest, Bot, FolderOpen, Pencil, Save, CornerDownRight, ListTree, } from "lucide-react";
export default function TaskDetailDrawer({ task, boardId, allTasks = [], onTaskClick, onClose, }) {
